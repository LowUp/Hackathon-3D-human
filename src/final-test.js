...
let scene, camera, droneCamera, thirdPersonCamera, renderer, slider, yearLabel, orbitCamera,terrain, user, labelRenderer, mixer, idle, walk, action_idle, action_walk;
